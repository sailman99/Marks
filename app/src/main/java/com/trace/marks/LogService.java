...
public class LogService extends Service {
	...
	private SimpleDateFormat myLogSdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss",Locale.CHINA);
	private OutputStreamWriter writer;

	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HHmmss",Locale.CHINA);//日志名称格式
	...
	public void createLogCollector() {
		...
		//	commandList.add("*:I");
		//	commandList.add("myApp:I");
		//commandList.add("*:E");// 过滤所有的错误信息

		// 过滤指定TAG的信息
		// commandList.add("gpsclient.WifiScanListener:I");
		// commandList.add("*:S");
		commandList.add("-s");
		commandList.add("gpsclient.WifiScanListener:I");
		commandList.add("gpsclient.mina:I");
		commandList.add("gpsclient.GpsStatues:I");
		commandList.add("gpsclient.ScreenStatusListener:I");
		commandList.add("gpsclient.GpsService:I");
		commandList.add("gpsclient.Message:I");
		commandList.add("gpsclient.Message:D");
